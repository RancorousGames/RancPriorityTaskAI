...
#include "RAIManagerToPawnInterface.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class URAIManagerToPawnInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 */
class RANCPRIORITYTASKAI_API IRAIManagerToPawnInterface
{
	GENERATED_BODY()
